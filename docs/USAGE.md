...
**Solution:** The module uses a server-side proxy (`/api/_cms/...`) to protect the API key. Make sure:
...
```typescript
import type { CmsCollectionResult, CmsItem } from 'ginko-nuxt'
