...
/** Options for {@link useGinkoSearchV2}. */
export interface UseGinkoSearchV2Options {
...
/** Return shape of {@link useGinkoSearchV2}. */
export interface UseGinkoSearchV2Result {
 ...
 * ```ts
 * // Single collection
 * const { query, results, pending } = useGinkoSearchV2('docs')
 *
 * // Multiple collections
 * const search = useGinkoSearchV2(['blog', 'docs'], { limit: 12 })
 *
 * // All collections
 * const search = useGinkoSearchV2()
 * ```
 */
export function useGinkoSearchV2(
  collections?: string | string[],
  options: UseGinkoSearchV2Options = {},
): UseGinkoSearchV2Result {
  const {
